...
const starts = async (dha = new WAConnection()) => {
	...
	console.log(color(figlet.textSync('NABIL', {
		font: 'Standard',
	...
	dha.on('connecting', () => {
		console.log(color('[ NABIL ]', 'yellow'), color('PROSES NYAMBUNG...'));
	})
const spinner = { 
  "interval": 120,
  "frames": [
	...
	//connect
	dha.on('open', () => {
		console.log(color('[ NABIL ]', 'yellow'), color('BOT SUDAH AKTIF  SELAMAT MENGGUNAKAN'));
	})
