...
petik = '```'
fake = '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 NABIL'//GANTI NAMA KAMU BEP
ban =[]
...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 NABIL","listType": "SINGLE_SELECT","sections": list}}, {})
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/sherlynn.jpg`)},"title": `© Nabil`,"description": "ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Nabil", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "Nabil","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
*Sewa bot?* Chat wa.me/6281938835391`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 NABIL', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTIVD dibawah!*`
       ...
       case 'othercmd':
               ...
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 NABIL ' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
       ...
       case 'store':
               ...
               listmsg(from, `${ucapanWaktu}`,   `© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 NABIL`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
...
╰────
╭─「 Sistem 」
│• SEND LINK GRUP-BOT MASUK-TF-DONE
╰────
╭─「 Grup Botz 」
│• https://linktr.ee/nabil_firmansyah_
╰────
╭─「 Nomer Owner 」
│• wa.me/6288989575662
╰────
...
case 'priceff':
              gopeynya = 'https://i.ibb.co/kynNYTh/ganteng.jpg'
              teksnya = `*LIST HARGA DIAMOND FREE FIRE VIA ID*
*Proses 5-30 menit setelah admin cek bukti pembayaran*
...
case 'rulesr':
              gopeynya = 'https://i.ibb.co/kynNYTh/ganteng.jpg'
              teksnya = `*_Welcome To SINIPER ID!_*
*Rules* (Peraturan) :
...
*Untuk selengkapnya open Member bisa hubungin Kapten/Officer*
*Wajib Nge team tour!!*
*No Sparing Guild!!*
...
*7HARI GA ON TANPA IZIN KICK!!*

*ID Guild :* 1008560928 (SINIPER•ID)
*Minat Join? Chat* wa.me/6281938835391
#WAVEFOREVER!`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
...
case 'tiktok':
              ...
              imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/sherlynn.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/sherlynn.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Subscribe Yt NABNAB 01\n Helpme tu 1k subscriber', imageMessage: imageMsg,
       ...
       case 'img2url':
         ...
         case 'asupan': // shansekai                
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, '\`\`\`ASUPAN BRO GUA DAPAT DARI ORANG\`\`\`')
...
dha.sendMessage(from, tapib1, document, { quoted: mek, filename:`NABIL ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
              ...
              break
       case 'youtube': 
              reply(`*Subcribe YT Owner :*\n https://youtube.com/channel/UCGQzOIGQIkxLGjKzyH2thwg`)
              break
       case 'masukandata':
...
dha.sendMessage(_.jid, 
			{"contentText": `*「 Siaran BOTZ-NABIL 」*\n© BOTZ-NABIL\n*Isi Pesan :* ${body.slice(4)}`,
			"footerText": '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 NABIL',
			"buttons": [
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              dha.sendMessage('6281938835391@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
         ...
         case 'pulsa':
             ...
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://www.instagram.com/nab.nab_27`)
             break
      case 'grupbot':
